...
public interface SubscriberRepository extends CrudRepository<Message, Integer> { //CrudRepository<T,ID> T is the repository ID is the specific type
        ...
        List<Message> getAllSubscriberMessages(int s_id);//Referencing subscriber.id here for where clause RequestParam
